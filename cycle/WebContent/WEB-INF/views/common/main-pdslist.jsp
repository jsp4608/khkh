...
<table class="pds-table" style="width:80%;">
<thead>
<tr>
...
<tr>
	...
	<td style="text-align: left"><jsp:getProperty property="arrow" name="pdsA"/><a href='pdsdetail.do?seq=${pds.seq}'>${pds.title}</a></td>
	<td style="text-align: center">
		<input type="image" src="./img/file2.PNG" name="btnDown2" value="다운"
...
<td style="text-align: center">${pds.regdate}</td>

<td style="text-align: center">
<img src="./img/del.png"  data-attache_file_name="${pds.seq}"
...
<table style="margin-left:auto; margin-right:auto; margin-top:3px; margin-bottom:1px;">
<tr>
	<td>검색 : </td>
	...
	<td style="padding-left:10px;"><button type="button" id="_btnSearch"> 검색 </button></td>
	<td style="padding-left:10px;"><button type="button" id="_btnAdd">글쓰기</button></td>
</tr>
</table>
...
$("#_btnSearch").click(function() {
	$("#_frmFormSearch").attr({ "target":"_self", "action":"pdslist.do" }).submit();
});


function goPage(pageNumber) {	
	$("#_pageNumber").val(pageNumber) ;
	$("#_frmFormSearch").attr("target","_self").attr("action","pdslist.do").submit();
}
