...
<%-- <input type="hidden" name="pollsubid" value="${pollsublist.pollsubid }"/> --%>
	...
	<div class="form-group">
	    <label>투표 결과(전체 투표자: ${meet.polltotal }명)</label><br>
	</div>
	...
	<div class="form-group">
		<label>${vs.count }번</label><br>
		<input type="text" size="60" readonly="readonly" class="form-control input-sm" 
				name="answer" value="${psub.answer }" style="width : 500px;"><br>
						...
						<td colspan="3">
							<div
								...
								<c:if test="${login.id eq i.id}">
									...
									style="width:120px; height: 30px; font-size: 13px; border-radius: 4px;">삭제</button>
								</c:if> 
								</div>
							</div>
						</td>
